...
const Model: React.FC<{ fileUrl: string; scale?: [number, number, number]; position?: [number, number, number] }> = ({ fileUrl, scale = [1, 1, 1], position = [0, 0, 0] }) => {
    const { scene } = useGLTF(fileUrl) as { scene: THREE.Object3D };
...
const GltfViewerHome: React.FC<{ fileUrl: string; scale?: [number, number, number]; position?: [number, number, number] }> = ({ fileUrl, scale = [1, 1, 1], position = [0, 0, 0] }) => {
    return (
