        ...
        <section className="relative container mx-auto z-10  my-20 pb-10">
            <div className="w-full overflow-hidden">
                <div className="relative z-20 flex flex-row w-full lg:w-11/12 mx-auto px-4 lg:!px-0">
                        ...
                        <div className="w-full mt-2 md:pt-4 flex flex-col lg:flex-row">
                            <div className="w-full lg:w-1/3 flex flex-row mt-6 md:!mt-0">
                                <div className="relative w-3/12">
                                    <div className="absolute bottom-6 top-0 rounded-full w-12 h-12 bg-[#04345c] flex pl-3 items-center">
                    ...
                    <div className="relative hidden md:inline md:w-5/12 lg:w-4/12 mt-12 justify-items-center rounded-3xl bottom-0">
                        <img
