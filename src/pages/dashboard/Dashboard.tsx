...
import { Users, ShoppingBag, BookOpen, DollarSign, TrendingUp, ChevronUp, ChevronDown } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-3xl drop-shadow-lg">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Link to="/dashboard/allorders" className="text-sm text-blue-600 hover:underline">View All</Link>
                    </div>
                    <div className="space-y-4">
                        {recentOrders.map((order) => (
                            <div key={order._id} className="flex justify-between border border-slate-200 drop-shadow-md transition duration-300 items-center p-3 hover:bg-gray-50 rounded-xl">
                                <div>
                ...
                <div className="bg-white p-6 rounded-3xl drop-shadow-lg">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Link to="/dashboard/allProducts" className="text-sm text-blue-600 hover:underline">View All</Link>
                    </div>
                    <div className="space-y-4">
                        {topProducts.map((product) => (
                            <div key={product._id} className="flex items-center  border border-slate-200 drop-shadow-md transition duration-300  gap-4 p-3 hover:bg-gray-50 rounded-xl">
